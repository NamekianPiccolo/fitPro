...
def main():
    ...
    dataset_path = os.path.join(base_dir, 'ml', 'exercise_angles.csv')
    ...
    print(f"      Scaler tersimpan di: {os.path.join(models_dir, 'scaler.pkl')}")
    print(f"      Label Encoder tersimpan di: {os.path.join(models_dir, 'label_encoder.pkl')}")
    print("==================================================")
